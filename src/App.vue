...
<template>
	<div id="home">
		<div id="Filter">
			<div v-if="screenWidth > 720" class="all">
			...
			<div v-if="screenWidth <= 720" class="ydAll">
				<el-row style="height: 10vh"></el-row>
				<transition name="el-zoom-in-top">
					<div v-show="listStatus == false" class="hello">
				...
				<transition name="el-zoom-in-top">
					<div v-show="listStatus == true" class="menu">
						<el-row v-show="listStatus == true">
							<date></date>
						</el-row>
						<el-row v-show="listStatus == true" style="margin-top: 20px">
							<linkText></linkText>
						</el-row>
						<el-row v-show="listStatus == true">
							<linkContent></linkContent>
				...
				<menuBtn class="menuBtn" @list-change="getListStatus"></menuBtn>
				<el-row style="height: 15vh"></el-row>
			</div>
		</div>
	</div>
...
import yiyan from './components/yiyanItem.vue';
import wyy from './components/wyyItem.vue';
import date from './components/dateItem.vue';
import helloWorld from './components/helloWorld.vue';
import linkContent from './components/linkCard.vue';
import linkText from './components/linkText.vue';
import menuBtn from './components/menuSwitch.vue';
